...
export default function Footer() {
  ...
  return (
    <footer>
      <div className="mx-auto px-8 py-4 flex flex-row items-center justify-center">
        <div>
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger className="text-xs leading-6 text-slate-500 hover:cursor-default" onClick={(e) => e.preventDefault()}>
                <div className="flex flex-row gap-1 items-start items-center">
                  {t('Read Disclaimer')}
        ...
        <p className="w-full text-xs leading-6 text-slate-500 flex flex-row gap-1 justify-end">
          {t('Design')}:{' '}
          <a className="font-bold" href="https://www.linkedin.com/in/pedro-areal-torres/">
            Pedro Torres
          </a>
        </p>
      </div>
