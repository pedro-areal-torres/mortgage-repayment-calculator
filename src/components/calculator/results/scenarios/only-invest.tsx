...
export default function OnlyInvestResult({ calculation, currentTab, setShowForm }: Props) {
      ...
      <dd className="mt-1 text-md font-normal tracking-tight text-gray-900">
        ...
        <div className="flex flex-row w-full justify-between items-center">
          <DetailsSheet rows={mortgageDetails.monthlyPayments}>
            ...
            <ResultAssetDetails houseValue={assetsDetails.houseValue} savings={assetsDetails.savings} profit={investmentDetails.profit} />
