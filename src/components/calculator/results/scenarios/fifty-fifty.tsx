...
export default function FiftyFiftyResult({ calculation, currentTab, initialTotalMonths, setShowForm }: Props) {
    ...
    <div className={cn('overflow-hidden rounded-lg bg-white px-4 py-5 shadow-md sm:p-4')}>
      <dd className="mt-1 text-md font-normal tracking-tight text-gray-900">
        ...
        <div className="flex flex-row w-full justify-between items-center">
          ...
          <Button variant={'outline'} onClick={() => setShowForm(true)} className="block lg:hidden">
            {t('Back')}
          </Button>
        </div>
      </dd>
