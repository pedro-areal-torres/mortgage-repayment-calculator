...
const resources = {
  en: {
    translation: {
      ...
      'Expected Repayment every 12 months': 'Expected Repayment every 12 months',
      'Return on Repayment': 'Return on Repayment',
      'Mortgage scenarios': 'Mortgage scenarios',
      noAction: 'Mortgage Without Repayments',
      Repayment: 'Repayment',
      ...
      'Calculator info': 'Fill in the values assuming you want to amortize your mortgage',
      ...
      'House Inflation': 'Considers a 2% appreciation of the house since the year of purchase',
      ...
      onlyRepayment: 'Only Repayments',
      Resume: 'Resume',
      'Cost details': 'Cost details',
      'Assets details': 'Assets details',
      'Total Assets': 'Total Assets',
      'Capital at Risk': 'Capital at Risk (not guaranteed)',
      Return: 'Return',
      'From today out pocket': 'From today out pocket',
      'Total Assets by end': 'Total Assets',
  ...
  es: {
    translation: {
      ...
      'Mortgage Calculator': 'Esta herramienta fue desarrollada en el ámbito del artículo: ',
      'Amount in Debt': 'Capital en deuda',
      'Annual Interest Rate': 'Taxa de juro (spread + euribor)',
      ...
      noAction: 'No amortizar ni invertir',
      ...
      'House Inflation': 'Considera una valorización del 2% de la casa desde el año de compra',
      ...
      'Past not included': 'Excluye cuotas pagadas desde el inicio del préstamo hasta hoy',
  ...
  pt: {
    translation: {
      ...
      noAction: 'Não amortizar nem investir',
      ...
      onlyRepayment: 'Apenas amortizar',
      Resume: 'Resumo',
      'Cost details': 'Custos',
      'Assets details': 'Ganhos',
      'Total Assets': 'Património total',
      'Capital at Risk': 'Capital em risco (não garantido)',
      Return: 'Retorno',
      'From today out pocket': 'Sairá do seu bolso',
      'Total Assets by end': 'Ganhos',
